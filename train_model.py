...
def update_params(net):
    params_to_update_1 = []  # phần features
    params_to_update_2 = []  # phần FC1, FC2
    params_to_update_3 = []  # phần output (classifier cuối)
...
def train_model(model, dataloader_dict, criterion, optimizer, num_epoch, scheduler):
    ...
    train_accuracies = []
    val_accuracies = []
    best_acc = 0.0  # <-- lưu độ chính xác cao nhất
    best_model_wts = copy.deepcopy(model.state_dict())  # cần import copy
    ...
    for epoch in range(num_epoch):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'train':
                ...
                # ===> Thêm đoạn lưu model tốt nhất ở đây <===
